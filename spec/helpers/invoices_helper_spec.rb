...
RSpec.describe InvoicesHelper, type: :helper do
  ...
  describe "#amount_to_currency" do
    it "formats the number 1234 to English currency style: '£1,234.00'" do
      expect(helper.amount_to_currency(1234)).to eq '£1,234.00'
    end

    it "formats the number 136.03 to English currency style: '£136.03'" do
      assigne_invoice_json
  ...
  describe "#total_to_currency" do
    it "formats the total amount of bill to English currency style: '£136.03'" do
      assigne_invoice_json
